...
for i in np.arange(1,6):
    ...
    trajin {prefix}{i}.xtc 2001 last 1
    rms first :71-109@CA
    atomicfluct :65-130&!@H= byres out ./RMSF/{prefix}{i}_sub1rmsf.dat 
    go
    quit
    """
...
for i in np.arange(1,6):
    rmsf = f"""parm {prefix}.prmtop
    trajin {prefix}{i}.xtc 2001 last 1
    rms first :137-175@CA
    atomicfluct :131-196&!@H= byres out ./RMSF/{prefix}{i}_sub2rmsf.dat 
    go
    quit
    """
